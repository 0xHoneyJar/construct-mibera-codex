---
title: Capricorn
description: "Grail #8971 — Aegipan and Pan as Capricorn with Saturn frequency and 7 pipes. Zodiac · Mibera Maker Vol I."
---
...
> **Grail #8971** · Zodiac · [Browse all Grails →](https://github.com/0xHoneyJar/construct-mibera-codex/blob/main/browse/grails.md)
...
```bash
# CLI
micodex lookup grail capricorn --field=image

# MCP (any client)
lookup_grail({query: "capricorn"})

# Raw — read from canonical JSONL
curl -s https://raw.githubusercontent.com/0xHoneyJar/construct-mibera-codex/main/_codex/data/grails.jsonl | jq 'select(.slug=="capricorn")'
```
