# The Drug-Tarot System

*78 tarot cards mapped to 78 drugs — where ancient mysticism meets pharmacological reality.*
...
Drugs are classified into three temporal categories:

| Category | Count | Description |
|----------|-------|-------------|
| **Ancient** | 38 | Traditional plant medicines and substances used for millennia |
| **Modern** | 35 | Synthetic and semi-synthetic compounds from the 19th century onward |
| **Both** | 5 | Substances with ancient roots that persist in modern forms |
...
## Ancient ↔ Modern Pairings

Many drugs exist in pairs — an ancient plant medicine and its modern synthetic descendant or analog:

| Ancient | Modern | Connection |
|---------|--------|------------|
| Ephedra | Dextroamphetamine | Stimulant alkaloids |
| Ephedra | Methamphetamine | Stimulant alkaloids |
| Kwao Krua | Estrogen | Phytoestrogens |
| Psilocybin Mushrooms | Synthetic Psilocybin | Same molecule |
...
Each Archetype (Rave Tribe) has natural affinities with certain drug categories:
...
### Chicago Detroit
**Modern:** Vape, NOS, Poppers, Cocaine, MDMA, Crack
...
## Integration with Ancestors

Drugs also connect to cultural Ancestors based on historical usage:

- **Hindu:** Bhang, Datura, Ashwagandha, CBD
- **Mayan:** Ayahuasca, DMT, Ololiuqui
- **Native American:** Peyote, Tobacco, Datura, Sassafras
- **Greek:** Wine (Dionysus), Opium, Kykeon
